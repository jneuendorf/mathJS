describe "Numbers:", () ->
    ...
    ########################################################################################################################
    ########################################################################################################################
    describe "Number (reals)", () ->

        it "creation", () ->
            expect(mathJS.Number.new(12).value)
                .toBe(12)

            expect(mathJS.Number.parse("12e-2").equals(mathJS.Number.new(0.12)))
                .toBe(true)
        ...
        it "comparison", () ->
            ...
            expect(mathJS.Number.new(42).equals(n1))
                .toBe(true)
    ...
    ########################################################################################################################
    ########################################################################################################################
    describe "Int (integers)", () ->

        it "creation", () ->
            expect(mathJS.Int.new(12).value)
                .toBe(12)

            expect(mathJS.Int.parse("12").equals(mathJS.Int.new(12)))
                .toBe(true)

            expect(mathJS.Int.parse("12.12345").equals(mathJS.Int.new(12)))
                .toBe(true)
